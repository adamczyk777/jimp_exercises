...
int main() {
    ...
    map<string, JsonValue> obj_v {{"values",JsonValue{js}},{"name",JsonValue{"Test name"s}}, {"string", JsonValue{""s}}, {"age",JsonValue{13}}};
    JsonValue obj {obj_v};
    ...
    cout << "string: " << obj.ValueByName("string")->ToString() << endl;
